...
private fun FieldRules.protoMergeImpl(plus: pbandk.Message?): FieldRules = (plus as? FieldRules)?.copy(
...
private fun FloatRules.protoMergeImpl(plus: pbandk.Message?): FloatRules = (plus as? FloatRules)?.copy(
...
private fun DoubleRules.protoMergeImpl(plus: pbandk.Message?): DoubleRules = (plus as? DoubleRules)?.copy(
    const = plus.const ?: const,
    lt = plus.lt ?: lt,
    lte = plus.lte ?: lte,
    gt = plus.gt ?: gt,
...
private fun Int32Rules.protoMergeImpl(plus: pbandk.Message?): Int32Rules = (plus as? Int32Rules)?.copy(
    const = plus.const ?: const,
    lt = plus.lt ?: lt,
    lte = plus.lte ?: lte,
    gt = plus.gt ?: gt,
...
private fun Int64Rules.protoMergeImpl(plus: pbandk.Message?): Int64Rules = (plus as? Int64Rules)?.copy(
    const = plus.const ?: const,
    lt = plus.lt ?: lt,
    lte = plus.lte ?: lte,
    gt = plus.gt ?: gt,
...
private fun UInt32Rules.protoMergeImpl(plus: pbandk.Message?): UInt32Rules = (plus as? UInt32Rules)?.copy(
    const = plus.const ?: const,
    lt = plus.lt ?: lt,
    lte = plus.lte ?: lte,
    gt = plus.gt ?: gt,
...
private fun UInt64Rules.protoMergeImpl(plus: pbandk.Message?): UInt64Rules = (plus as? UInt64Rules)?.copy(
    const = plus.const ?: const,
    lt = plus.lt ?: lt,
    lte = plus.lte ?: lte,
    gt = plus.gt ?: gt,
...
private fun SInt32Rules.protoMergeImpl(plus: pbandk.Message?): SInt32Rules = (plus as? SInt32Rules)?.copy(
    const = plus.const ?: const,
    lt = plus.lt ?: lt,
    lte = plus.lte ?: lte,
    gt = plus.gt ?: gt,
...
private fun SInt64Rules.protoMergeImpl(plus: pbandk.Message?): SInt64Rules = (plus as? SInt64Rules)?.copy(
    const = plus.const ?: const,
    lt = plus.lt ?: lt,
    lte = plus.lte ?: lte,
    gt = plus.gt ?: gt,
...
private fun Fixed32Rules.protoMergeImpl(plus: pbandk.Message?): Fixed32Rules = (plus as? Fixed32Rules)?.copy(
    const = plus.const ?: const,
    lt = plus.lt ?: lt,
    lte = plus.lte ?: lte,
    gt = plus.gt ?: gt,
...
private fun Fixed64Rules.protoMergeImpl(plus: pbandk.Message?): Fixed64Rules = (plus as? Fixed64Rules)?.copy(
    const = plus.const ?: const,
    lt = plus.lt ?: lt,
    lte = plus.lte ?: lte,
    gt = plus.gt ?: gt,
...
private fun SFixed32Rules.protoMergeImpl(plus: pbandk.Message?): SFixed32Rules = (plus as? SFixed32Rules)?.copy(
    const = plus.const ?: const,
    lt = plus.lt ?: lt,
    lte = plus.lte ?: lte,
    gt = plus.gt ?: gt,
...
private fun SFixed64Rules.protoMergeImpl(plus: pbandk.Message?): SFixed64Rules = (plus as? SFixed64Rules)?.copy(
    const = plus.const ?: const,
    lt = plus.lt ?: lt,
    lte = plus.lte ?: lte,
    gt = plus.gt ?: gt,
...
private fun BoolRules.protoMergeImpl(plus: pbandk.Message?): BoolRules = (plus as? BoolRules)?.copy(
    const = plus.const ?: const,
    unknownFields = unknownFields + plus.unknownFields
) ?: this
...
private fun StringRules.protoMergeImpl(plus: pbandk.Message?): StringRules = (plus as? StringRules)?.copy(
    const = plus.const ?: const,
    len = plus.len ?: len,
...
private fun BytesRules.protoMergeImpl(plus: pbandk.Message?): BytesRules = (plus as? BytesRules)?.copy(
    const = plus.const ?: const,
    len = plus.len ?: len,
    minLen = plus.minLen ?: minLen,
    maxLen = plus.maxLen ?: maxLen,
...
private fun EnumRules.protoMergeImpl(plus: pbandk.Message?): EnumRules = (plus as? EnumRules)?.copy(
    const = plus.const ?: const,
...
private fun MessageRules.protoMergeImpl(plus: pbandk.Message?): MessageRules = (plus as? MessageRules)?.copy(
    skip = plus.skip ?: skip,
...
private fun RepeatedRules.protoMergeImpl(plus: pbandk.Message?): RepeatedRules = (plus as? RepeatedRules)?.copy(
...
private fun MapRules.protoMergeImpl(plus: pbandk.Message?): MapRules = (plus as? MapRules)?.copy(
...
private fun AnyRules.protoMergeImpl(plus: pbandk.Message?): AnyRules = (plus as? AnyRules)?.copy(
    required = plus.required ?: required,
    `in` = `in` + plus.`in`,
    notIn = notIn + plus.notIn,
    unknownFields = unknownFields + plus.unknownFields
...
private fun DurationRules.protoMergeImpl(plus: pbandk.Message?): DurationRules = (plus as? DurationRules)?.copy(
    required = plus.required ?: required,
...
private fun TimestampRules.protoMergeImpl(plus: pbandk.Message?): TimestampRules = (plus as? TimestampRules)?.copy(
    required = plus.required ?: required,
    const = const?.plus(plus.const) ?: plus.const,
    lt = lt?.plus(plus.lt) ?: plus.lt,
    lte = lte?.plus(plus.lte) ?: plus.lte,
